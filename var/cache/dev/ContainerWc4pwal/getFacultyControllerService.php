...
// Returns the public 'AppBundle\Controller\FacultyController' shared autowired service.
...
include_once $this->targetDirs[3].'/src/AppBundle/Controller/FacultyController.php';

return $this->services['AppBundle\Controller\FacultyController'] = new \AppBundle\Controller\FacultyController();
