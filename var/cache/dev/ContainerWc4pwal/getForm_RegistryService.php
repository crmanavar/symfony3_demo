...
return $this->services['form.registry'] = new \Symfony\Component\Form\FormRegistry(array(0 => new \Symfony\Component\Form\Extension\DependencyInjection\DependencyInjectionExtension(new \Symfony\Component\DependencyInjection\ServiceLocator(array('AppBundle\\Form\\DepartmentType' => function () {
    return ${($_ = isset($this->services['AppBundle\Form\DepartmentType']) ? $this->services['AppBundle\Form\DepartmentType'] : $this->services['AppBundle\Form\DepartmentType'] = new \AppBundle\Form\DepartmentType()) && false ?: '_'};
}, 'AppBundle\\Form\\FacultyType' => function () {
    return ${($_ = isset($this->services['AppBundle\Form\FacultyType']) ? $this->services['AppBundle\Form\FacultyType'] : $this->services['AppBundle\Form\FacultyType'] = new \AppBundle\Form\FacultyType()) && false ?: '_'};
